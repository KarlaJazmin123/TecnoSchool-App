...
class Analisis_estadistico_financieroE : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_analisis_estadistico_financiero_e)

        val btnRegresar2 = findViewById<Button>(R.id.btnRegresar2)
        btnRegresar2.setOnClickListener {
            val intent = Intent(this, Analisis_hipotesisE::class.java)
