...
class Caracteristicas_PrincipalesE : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_caracteristicas_principales_e)
        ...
        btnSiguiente.setOnClickListener {
            val intent = Intent(this, Uso_Comun_Excel::class.java)
            startActivity(intent)
            finish()
        }
