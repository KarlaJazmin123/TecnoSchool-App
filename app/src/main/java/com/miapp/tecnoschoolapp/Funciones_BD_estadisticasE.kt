...
class Funciones_BD_estadisticasE : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_funciones_bd_estadisticas_e)



        val btnRegresar2 = findViewById<Button>(R.id.btnRegresar2)
        btnRegresar2.setOnClickListener {
            val intent = Intent(this, Funciones_logicas_combinadasE::class.java)
            startActivity(intent)
            finish()
        }
        val btnSiguiente = findViewById<Button>(R.id.btnSiguiente)
        btnSiguiente.setOnClickListener {
            val intent = Intent(this, Validacion_proteccion_datosE::class.java)
            startActivity(intent)
            finish()
        }
