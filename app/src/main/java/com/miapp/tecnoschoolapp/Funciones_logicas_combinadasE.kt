...
class Funciones_logicas_combinadasE : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_funciones_logicas_combinadas_e)
        ...
        btnSiguiente.setOnClickListener {
            val intent = Intent(this, Funciones_BD_estadisticasE::class.java)
            startActivity(intent)
            finish()
        }
